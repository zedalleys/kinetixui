...
```bash
npx @kinetixui/cli add input
```

## Usage

```tsx
import { Input } from "@kinetixui/ui";
...
the control — they belong to the [`Field`](/docs/components/field) composition.
