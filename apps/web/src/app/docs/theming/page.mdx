...
[`preset swiftui`](/docs/cli), [`preset compose`](/docs/cli) and
[`preset flutter`](/docs/cli) resolve a preset into a `KinetixColors` pair for
[SwiftUI](/docs/swiftui), [Compose](/docs/compose) and [Flutter](/docs/flutter).
