export const metadata = {
  title: "Tokens",
  description: "How the token engine works: DTCG source files compiled by Style Dictionary into CSS variables, a typed TypeScript object, and native colour, type, spacing and motion constants for SwiftUI, Compose and Flutter.",
};
