...
required to be on all four catalogue-complete platforms (or a documented
non-port) and CI-verified like everything else; `beta` here means "new," not "incomplete."
