...
The [SwiftUI](/docs/swiftui) port covers the same ground (58 `Kinetix*`
views; data-heavy components deferred to native SwiftUI). Flutter isn't
started — the token engine emits Dart, but there's no `Kinetix*` library
for it yet.
