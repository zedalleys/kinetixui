export const metadata = {
  ...
  description: "The native Android component library — 74 Kotlin composables on the KinetixUI token contract.",
};

# Jetpack Compose

`packages/ui-compose` is a native **Jetpack Compose** port of KinetixUI —
**74 `Kinetix*` composables** on the same token contract as the web
...
All 74, one per React component — Button, Input, Dialog, Popover, Sheet,
...
full React surface too (SwiftUI carries 74 `Kinetix*` views, Flutter 73;
