export const metadata = {
  ...
  description: "The native Android component library — 83 Kotlin composables on the KinetixUI token contract.",
};

# Jetpack Compose

`packages/ui-compose` is a native **Jetpack Compose** port of KinetixUI —
**83 `Kinetix*` composables** on the same token contract as the web
...
All 83, one per React component — Button, Input, Dialog, Popover, Sheet,
...
full React surface too (SwiftUI carries 83 `Kinetix*` views, Flutter 82;
