export const metadata = {
  ...
  description: "The native Android component library — 71 Kotlin composables on the KinetixUI token contract.",
};

# Jetpack Compose

`packages/ui-compose` is a native **Jetpack Compose** port of KinetixUI —
**71 `Kinetix*` composables** on the same token contract as the web
...
All 71, one per React component — Button, Input, Dialog, Popover, Sheet,
...
full React surface too (SwiftUI carries 71 `Kinetix*` views, Flutter 70;
