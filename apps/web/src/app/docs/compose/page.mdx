export const metadata = {
  ...
  description: "The native Android component library — 72 Kotlin composables on the KinetixUI token contract.",
};

# Jetpack Compose

`packages/ui-compose` is a native **Jetpack Compose** port of KinetixUI —
**72 `Kinetix*` composables** on the same token contract as the web
...
All 72, one per React component — Button, Input, Dialog, Popover, Sheet,
...
full React surface too (SwiftUI carries 72 `Kinetix*` views, Flutter 71;
