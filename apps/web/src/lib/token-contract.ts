...
export const TOKEN_CONTRACT: TokenRow[] = [
  ...
  { token: "primary", light: "#163042", dark: "#92b2c8" },
  { token: "primary-foreground", light: "#f0f7ff", dark: "#050c11" },
  { token: "secondary", light: "#e3e7e3", dark: "#2e362e" },
  ...
  { token: "accent-foreground", light: "#163042", dark: "#f0f7ff" },
  ...
  { token: "ring", light: "#163042", dark: "#92b2c8", note: "synthesized" },
];
