...
object KinetixTheme {
  ...
  val colorAccentForeground = Color(0xff163042)
  val colorBackground = Color(0xffffffff)
  val colorBorder = Color(0xff92b2c8)
  val colorCard = Color(0xffffffff)
  val colorCardForeground = Color(0xff050c11)
  val colorChart1 = Color(0xff1b3c53)
  val colorChart2 = Color(0xff748873)
  ...
  val colorInfoForeground = Color(0xfff0f7ff)
  val colorInput = Color(0xff92b2c8)
  val colorMuted = Color(0xfff6f6f6)
  val colorMutedForeground = Color(0xff6d6d6d)
  val colorPopover = Color(0xffffffff)
  val colorPopoverForeground = Color(0xff050c11)
  val colorPrimary = Color(0xff163042)
  val colorPrimaryForeground = Color(0xfff0f7ff)
  val colorRing = Color(0xff163042)
  val colorSecondary = Color(0xffe3e7e3)
  ...
  val colorSemanticOnSuccessContainer = Color(0xff465245)
  val colorSemanticOnWarningContainer = Color(0xfff97907)
  val colorSemanticSuccessContainer = Color(0xfff1f3f1)
  val colorSemanticWarning = Color(0xfff97907)
