...
fun KinetixCalendar(
    ...
    DatePicker(
        ...
        colors = DatePickerDefaults.colors(
            ...
            currentYearContentColor = colors.action,
            selectedYearContentColor = colors.actionForeground,
            selectedYearContainerColor = colors.action,
            dayContentColor = colors.foreground,
            disabledDayContentColor = colors.mutedForeground,
            selectedDayContentColor = colors.actionForeground,
            selectedDayContainerColor = colors.action,
            todayContentColor = colors.action,
            todayDateBorderColor = colors.action,
        ),
    )
}
